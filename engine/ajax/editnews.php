...
<div class="xfieldsrow"><label><input type="checkbox" name="approve" value="1" {$fix_approve}>{$lang['add_al_ap']}</label>&nbsp;&nbsp;<label><input type="checkbox" name="allow_br" value="1" {$fix_br}>{$lang['aj_allowbr']}</label></div>
</form>
{$js_code}
<script type="text/javascript">
