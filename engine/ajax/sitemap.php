...
// if (strpos ( send_url("https://ping.blogs.yandex.ru/ping?sitemap=", $map_link), "OK" ) !== false) {

//	$buffer .= "<br />".$lang['sitemap_send']." Yandex: ".$lang['nl_finish'];

// } else {

//	$buffer .= "<br />".$lang['sitemap_send']." Yandex: ".$lang['nl_error']." URL: <a href=\"https://ping.blogs.yandex.ru/ping?sitemap=".urlencode($map_link)."\" target=\"_blank\">https://ping.blogs.yandex.ru/ping?sitemap={$map_link}</a>";
