  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10 col-sm-9">
			<input type="text" name="title" class="form-control width-500" value="{$title}"><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_vtitle']}" ></i>
		  </div>
		 </div>
		<div class="form-group">
		  ...
		  <div class="col-md-10 col-sm-9">
			<select data-placeholder="{$lang['addnews_cat_sel']}" name="category[]" class="cat_select" multiple>
				...
				{$opt_category}
			</select><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_vcat']}" ></i>
		  </div>
		 </div>
		<div class="form-group">
