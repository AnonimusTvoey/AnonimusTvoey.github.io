	...
	$('#sendbutton').click(function() {
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-8 col-xs-6">
			<input type="text" class="form-control" style="width:60px;" name="limit"><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_g_num']}" ></i>
		   </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-sm-4 col-xs-6">{$lang['google_stat_priority']}</label>
		  <div class="col-sm-8 col-xs-6">
			<input type="text" class="form-control" style="width:60px;" name="stat_priority" value="0.5"><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_g_priority']}" ></i>
		   </div>
		 </div>
		<div class="form-group">
