...
if ($_POST['action'] == "add") {
	...
	$db->query( "INSERT INTO " . PREFIX . "_metatags (`url`, `title`, `description`, `keywords`, `page_title`, `page_description`) values ('{$url}', '{$headers['title']}', '{$headers['description']}', '{$headers['keywords']}', '{$page_title}', '{$page_description}' )" );
...
if ($_POST['action'] == "edit") {
	...
	$db->query( "UPDATE " . PREFIX . "_metatags SET `url`='{$url}', `title`='{$headers['title']}', `description`='{$headers['description']}', `keywords`='{$headers['keywords']}', `page_title`='{$page_title}', `page_description`='{$page_description}' WHERE id='{$id}'" );
...
HTML;
        ...
        <td><div id=\"title_{$row['id']}\" data-description=\"{$row['description']}\" data-keywords=\"{$row['keywords']}\" data-pagetitle=\"{$row['page_title']}\">{$row['title']}</div><textarea id=\"descr_{$row['id']}\" style=\"display:none;\">{$row['page_description']}</textarea></td>
