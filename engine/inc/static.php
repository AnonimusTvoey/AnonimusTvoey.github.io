  ...
  <div class="modal-body">
	  ...
	  <div class="col-sm-12">
		...
		<div class="form-group">
		  <label class="control-label col-sm-4">{$lang['edit_search_static']}</label>
		  <div class="col-sm-8">
...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<div class="heading-elements">
		<ul class="icons-list">
			<li><a data-toggle="modal" data-target="#advancedsearch" href="#"><i class="fa fa-search position-left"></i>{$lang['static_advanced_search']}</a></li>
		</ul>
	</div>
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10">
			<input type="text" name="description" class="form-control width-550" maxlength="250"><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_sdesc']}" ></i>
		  </div>
		 </div>
		<div class="form-group">
...
HTML;
	...
	if( $config['allow_static_wysiwyg'] ) {
		...
		echo <<<HTML
		<div class="editor-panel"><div class="shadow-depth1">{$bb_code}<textarea class="editor" style="width:100%;height:350px;" name="template" id="template" onfocus="setFieldName(this.name)"></textarea></div></div><script type=text/javascript>var selField  = "template";</script>
HTML;
	...
	echo <<<HTML
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10">
			{$lang['add_metatags']}<i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_metas']}" ></i>
		  </div>
		 </div>	
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10">
			{$skinlist}<i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-html="true" data-trigger="hover" data-placement="right" data-content="{$lang['hint_static_skin']}" ></i>
		  </div>
		 </div>	
		<div class="form-group">
...
HTML;
	...
	if( $_GET['page'] == "rules" ) {
		...
		<div class="form-group">
		  <label class="control-label col-md-2">{$lang['static_descr']}</label>
		  <div class="col-md-10">
			<input type="text" name="description" class="form-control width-550" maxlength="250" value="{$row['descr']}"><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_sdesc']}" ></i>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-2"></label>
...
HTML;
	...
	if( $config['allow_static_wysiwyg'] ) {
		...
		echo <<<HTML
		<div class="editor-panel"><div class="shadow-depth1">{$bb_code}<textarea class="editor" style="width:100%;height:350px;" name="template" id="template" onfocus="setFieldName(this.name)">{$row['template']}</textarea></div></div><script type=text/javascript>var selField  = "template";</script>
HTML;
	...
	echo <<<HTML
		...
		<div class="form-group">
		  <label class="control-label col-md-2">{$lang['meta_descr']}</label>
		  <div class="col-md-10">
			<input type="text" name="descr" id="autodescr" class="form-control width-500" maxlength="200" value="{$row['metadescr']}">
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-md-2">{$lang['meta_keys']}</label>
