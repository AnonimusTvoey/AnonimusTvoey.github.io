...
?>
		...
		<div id="default_image">		
			...
			<div class="form-group">
			  ...
			  <div class="col-md-10 col-sm-9">
				<input class="form-control text-center" style="width:100%;max-width: 100px;" type="text" name="editedxfield[10]" value="<?php echo htmlspecialchars($editedxfield[10], ENT_QUOTES, $config['charset']); ?>" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="<?php echo $lang['xfield_xi4']; ?>" ></i>
			  </div>
			</div>
			...
			<div id="optional5" class="form-group">
			  ...
			  <div class="col-md-10 col-sm-9">
				<input class="form-control text-center" style="width:100%;max-width: 100px;" type="text" name="editedxfield[16]" value="<?php echo htmlspecialchars($editedxfield[16], ENT_QUOTES, $config['charset']); ?>" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="<?php echo $lang['xfield_xi10']; ?>" ></i>
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-10 col-sm-9">
				<input class="form-control text-center" style="width:100%;max-width: 100px;" type="text" name="editedxfield[13]" value="<?php echo htmlspecialchars($editedxfield[13], ENT_QUOTES, $config['charset']); ?>" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="<?php echo $lang['xfield_xi8']; ?>" ></i>
			  </div>
			</div>
		</div>
		...
		<div id="default_file">
			<div class="form-group">
			  ...
			  <div class="col-md-10 col-sm-9">
				<input class="form-control width-350" type="text" name="editedxfield[14]" value="<?php echo htmlspecialchars($editedxfield[14], ENT_QUOTES, $config['charset']); ?>" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="<?php echo $lang['xfield_xf2']; ?>" ></i>
			  </div>
			</div>
			<div class="form-group">
			  <label class="control-label col-md-2 col-sm-3"><?php echo $lang['opt_sys_maxfile']; ?></label>
			  <div class="col-md-10 col-sm-9">
				<input class="form-control text-center" style="width:100%;max-width: 100px;" type="text" name="editedxfield[15]" value="<?php echo htmlspecialchars($editedxfield[15], ENT_QUOTES, $config['charset']); ?>" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="right" data-content="<?php echo $lang['opt_sys_maxfiled']; ?>" ></i>
			  </div>
			</div>
		</div>
	...
	foreach ($category as $cats_explode) {
		foreach ($xfields as $name => $value) {
			...
			if($value[3] == "yesorno") {
				...
				$newpostedxfields[$value[0]] = html_entity_decode($postedxfields[$value[0]], ENT_QUOTES, $config['charset']);
				...
				if($value[3] == "image" OR $value[3] == "imagegalery") {
					if( preg_match( "/[?&;<]/", $newpostedxfields[$value[0]]) OR stripos( $newpostedxfields[$value[0]], ".php" ) !== false ) $newpostedxfields[$value[0]] = "";
				}
  ...
  case "templatereplacepreview":
    ...
    foreach ($xfields as $value) {
		...
		if( $value[3] == "htmljs" ) {
			...
			if($value[3] == "image" OR $value[3] == "imagegalery") {
				if( preg_match( "/[?&;<]/", $xfield[$value[0]]) OR stripos( $xfield[$value[0]], ".php" ) !== false ) $xfield[$value[0]] = "";
			}
		...
		if($value[3] == "image" AND $xfield[$value[0]] ) {
			...
			if($thumb_url) {
				$xfield[$value[0]] = "<a href=\"$img_url\" class=\"highslide\"><img class=\"xfieldimage {$value[0]}\" src=\"$thumb_url\" alt=\"\" /></a>";
		...
		if($value[3] == "imagegalery" AND $xfield[$value[0]] ) {
			...
			foreach ($fieldvalue_arr as $temp_value) {
				...
				if($thumb_url) {
					$gallery_image[] = "<li><a href=\"$img_url\" onclick=\"return hs.expand(this, { slideshowGroup: 'xf_{$value[0]}' })\" target=\"_blank\"><img src=\"{$thumb_url}\" alt=\"\" /></a></li>";
				} else $gallery_image[] = "<li><img src=\"{$img_url}\" alt=\"\" /></li>";
			
			}
			
			$xfield[$value[0]] = "<ul class=\"xfieldimagegallery {$value[0]}\">".implode($gallery_image)."</ul><script type=\"text/javascript\">hs.addSlideshow({slideshowGroup: 'xf_{$value[0]}', interval: 4000, repeat: false, useControls: true, fixedControls: 'fit', overlayOptions: { opacity: .75, position: 'bottom center', hideOnMouseOut: true } });</script>";
